...
int main(int argc, char *argv[])
{
	...
	/*
	cout << "about to run generic code\n";
	shared_ptr<matrix_graph<vertex, edge>> my_graph = make_shared<matrix_graph<vertex, edge>>(10);
	generic_example<vertex, edge>(my_graph);
	shared_ptr<dg_graph<vertex, edge>> my_graph2 = make_shared<dg_graph<vertex, edge>>();
	generic_example<vertex, edge>(my_graph2);
	*/
	return 0;
}
...
template<typename V, typename E>
void generic_example(auto my_graph)
{
	using namespace graph_std_lib;
	...
	cout << '\n';
	cout << "v0 and v1 adjacent?\n";
	cout << adjacent(my_graph, v0, v1) << '\n';
	cout << "v0 and v3 adjacent?\n";
	cout << adjacent(my_graph, v0, v3) << '\n';
	cout << "path dfs\n";
...
void generic_matrix_example()
{
	...
	cout << "num vertices before: " << num_vertices(my_graph) << '\n';
	remove(my_graph, v11);
	remove(my_graph, v12);
	cout << "removed\n";
	cout << "num vertices after: " << num_vertices(my_graph) << '\n';
